...
fich_res = ['res_seedingRandom_nvs20_', problem, '_s3cx_pop', num2str(Npop), ...
...
% for loop on the Nexec executions
...
% Augmented Lagrangian Genetic Algorithm (ALGA)
    ...
    options_ga3step.InitialPopulation = tous_xi;
...
% Sequential Quadratic Programming
    ...
    x_sqp(:,1:5) = x_ga(:,1:5); % convert to integer
