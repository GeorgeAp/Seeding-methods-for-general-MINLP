...
fich_res = ['res_naive_nvs20_', problem, '_s3cx_pop', num2str(Npop), ...
...
for iexec = 1:Nexec
    ...
    [tous_yi_3step, pcent_invalides_ga] = nvs20_naive_sd(tolfun_naive_ga, tolcon_naive_ga, Npop, seed_iter, I, gen_ext_ga_sqp, handle_CNL, handle_obj); 
